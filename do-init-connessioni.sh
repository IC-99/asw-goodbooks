...
curl -X POST "http://10.10.10.10:8080/connessioni/connessioniautore" -H "accept: */*" -H "Content-Type: application/json" \
...
curl -X POST "http://10.10.10.10:8080/connessioni/connessionirecensore" -H "accept: */*" -H "Content-Type: application/json" \
